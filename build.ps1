# ew2 Build Script (PowerShell)
# Requires: Python 3.10+, pip

Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  ew2 Build Script" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
# Build
Write-Host "[INFO] Building ew2 (onefile)..." -ForegroundColor Yellow
...
$hash = (Get-FileHash -Path dist\ew2.exe -Algorithm SHA256).Hash.ToLower()

Write-Host ""
Write-Host "========================================" -ForegroundColor Green
Write-Host "  Build complete!" -ForegroundColor Green
Write-Host "  Output: dist\ew2.exe" -ForegroundColor Green
Write-Host "  Size: $([math]::Round((Get-Item dist\ew2.exe).Length / 1MB, 2)) MB" -ForegroundColor Green
